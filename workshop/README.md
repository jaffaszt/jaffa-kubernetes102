...
[Register IBM Cloud](https://ibm.biz/Bdq74e )
...
# To run the workshop using the Openshift consule run the whole LAB1 etc.  , alternatively if you want to use the kubectl cli continue to step 3 
